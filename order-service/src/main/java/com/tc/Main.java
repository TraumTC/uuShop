...
public class Main {
    public static void main(String[] args) {
        ...
        String outputDir = projectPath + "/order-service/src/main/java";
        ...
        FastAutoGenerator.create("jdbc:mysql://localhost:3306/uushop", "root", "123456")
                ...
                .packageConfig(builder -> {
                    builder.parent("com.tc")
                            ...
                            .pathInfo(Collections.singletonMap(OutputFile.xml, projectPath + "/order-service/src/main/resources/mapper"));
                })
                .strategyConfig(builder -> {
                    builder.addInclude("order_detail", "order_master")
